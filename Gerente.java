...
//  del mismo package o, si pertenecen a otros packages, siempre que tengan una relación extendida (herencia), es decir,
//   las clases secundarias pueden acceder a los miembros de su clase principal (o clase de abuelos, etc.).


// Private
// Este es el modificador de acceso más restrictivo de todos. Solo se puede acceder a los
//  miembros definidos como privados desde dentro de la clase y desde ningún otro lugar, 
